...
var createNum = document.querySelector('#createNum');
var callNum = document.querySelector('#callNum');
var nuwNum = document.querySelector('#newNum');
var queue1 = document.querySelector('#queue');
var n = 0;
var queue = [];
...
callNum.onclick = function () {
  ...
  screen.innerText = "\u8BF7".concat(m, "\u53F7\u5C31\u9910");
  queue1.innerText = JSON.stringify(queue);
};
